                ...
                <tbody>
                    <?php foreach ($lista as $d): ?>
                        <tr>
                            ...
                            <td><a href="/slz_alerta/controllers/denuncia_del_controller.php?id=<?= $d['id_denuncia']; ?>" class="text-decoration-none text-black d-flex align-center"><span class="material-symbols-outlined">delete</span>Deletar</a></td>
